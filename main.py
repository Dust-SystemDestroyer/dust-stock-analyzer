...
# 2. 분석 및 리포트 생성 함수
def run_analysis():
    # [추가] 종목코드와 이름을 매칭하는 사전(Dictionary)
    name_map = {
        '005930': '삼성전자', '000660': 'SK하이닉스', '035420': 'NAVER',
        '035720': '카카오', '005380': '현대차', '207940': '삼성바이오',
        '068270': '셀트리온', '105560': 'KB금융', '055550': '신한지주',
        '402340': 'SK스퀘어'
    }

    tickers = [
        'AAPL', 'TSLA', 'NVDA', 'MSFT', 'META', 'O', 'JPM', 'GOOGL', 'AMZN', 'SCHD',
        '005930', '000660', '035420', '035720', '005380', '207940', '068270', '105560', '055550', '402340'
    ]
